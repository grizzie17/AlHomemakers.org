...
g_sCalendarList = "" _
	&	"All" & vbTAB & "" & vbTAB & "Events / Rides" & vbLF _
	&	UCASE(g_sSiteChapter) & " Events" & vbTAB & LCASE(g_sSiteChapter) & vbTAB & UCASE(g_sSiteChapter) & " Events" & vbLF _
	&	UCASE(g_sSiteChapter) & " Rides" & vbTAB & LCASE(g_sSiteChapterID) & "-ride" & vbTAB & UCASE(g_sSiteChapter) & " Rides" & vbLF _
	...
	&	"Breakfast" & vbTAB & "breakfast" & vbTAB & "Breakfast" & vbLF _
	&	"Lunch" & vbTAB & "lunch" & vbTAB & "Lunch" & vbLF _
	&	"Supper" & vbTAB & "supper" & vbTAB & "Supper" & vbLF _
