...
<p align="right"><a href="#top">Back to Top</a></p>
<h3><a name="pictures">D</a>ownloads</h3>
<p>You can specify files that can be downloaded in your text.&nbsp;The download is
specified similarly to the picture using double braces (&quot;{{&quot;,
&quot;}}&quot;).&nbsp; The easiest method of specifying a download is:</p>
<blockquote>
<p>{{download <i>some-label</i>}}</p>
</blockquote>
<p>where the &quot;<i>some-label</i>&quot; is the label that you provided when you 
uploaded the file to the web-server.</p>
<%
sText =	"Some file {{download web-paint}} that is embedded in the line." & vbLF _
		&	vbLF _
		&	"* {{download bear-paw}}"
...
<%
	outputExample sText
%>
<p>A caption may be specified by providing text following a colon.&nbsp; Caption text may also be styled.</p>
<p>&nbsp;&nbsp;&nbsp; {{download some-label <b>:</b> <i>Caption text</i>}}</p>
<%
sText =	"{{download dancing-frog:Dancing {{i:Frog}} Cartoon}} "
