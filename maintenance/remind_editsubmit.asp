...
sStyle = Request("style")
sCategories = Request("categories")
sTime = Request("time")
sOffset = Request("offset")
sDuration = Request("duration")
sDurationView = Request("durationview")
sPending = Request("pending")
sDateType = Request("recurrence")
