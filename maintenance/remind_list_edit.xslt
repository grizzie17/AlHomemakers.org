...
<xsl:template match="event">
	<tr>
	<td><a><xsl:attribute name="href">remind_edit.asp?filename=$$Filename$$&amp;id=<xsl:value-of select="@id"/></xsl:attribute>edit</a></td>
	<td><a><xsl:attribute name="href">remind_delete.asp?filename=$$Filename$$&amp;id=<xsl:value-of select="@id"/></xsl:attribute>delete</a></td>
