...
<a href="http://www.gwrra.org/" target="_blank"><img border="0" src="<%=g_sTheme%>state_logo_100.gif" alt="Alabama"></a>&nbsp; 
</div>
...
<table border="0" cellspacing="0" width="100%">
  <tr>
    <td class="timeBlock">&nbsp; <%=g_sSiteCity%> &nbsp; &nbsp;</td>
    <td class="timeBlock" align="right"><a target="_blank" href="http://www.alhomemakers.org/">Alabama Homemakers</a> &nbsp;</td>
  </tr>
</table>
